...
GRE General sınavı, 2011 den itibaren değiştirilmiştir ve bu ara dönemde Revised GRE ya da New GRE olarak isimlendirilmektedir. Yeni GRE'nin \emph{Quantitive Analysis} Sayısal bölümlere başvuran okurlarımız için çok büyük değişiklikler yok. Eski GRE'de bulunan her şey yenisinde de var, bunun haricinde konular da aynı kalmış. Uygulanan tek değişiklik ise, size sorulan 20 sorudan 3-5 tanesinin şıklı olmaması. Bu sorularda ya bir kutucuğa problemin çözümünü yazmanız, ya da sunulan şıklardan birkaçını işaretlemeniz isteniyor. Ayrıca sınava bir ekran hesap makinesi eklenmiş, kendisine bence soruların cevaplarını kontrol etmek haricinde çok gerek yok. Soruların zorluk derecesi aynı, dolayısıyla bu bölümde eski GRE'deki gibi çok iyi bir sonuç getirmeniz gerekiyor.

Sınavda daha belirgin değişen kısım ise Verbal Reasoning kısmı. Burada, eski GRE deki gibi kelimelerde eşanlamlılığı, zıtlığı soran sorularda kelimeler yerine cümleleri odak alan soruların sayısı arttırılmış.  Örnek \ref{NewGREOrnek} de göründüğü gibi \emph{Verbal Reasoning} kısmında sadece kelime çalışarak, eşanlamlıları ve zıt anlamlıları ezberleyerek iyi puan almak zorlaştırılmış, ve okuduğunu anlayan, kelimelerin arasındaki ince farkları kavrayan kişiler ise ödüllendirilmiş. Cümle tamamlama sorularında çok boşluklu sorular da mevcut, bu sorular yüksek katsayılılar ve boşlukların hepsi doğru doldurulmadığı sürece puan alınamıyor. Birden fazla şıkkın doğru olduğu sorular bu bölüme de yeni konulmuş.
...
Analytical Writing denilen iki adet makalede yazana verilen süre eskiden 30 dakika ve 45 dakika iken, artık ikisini de 30 dakikada yazmanız isteniyor.

2011 sonu itibari ile genel kanı, Quantitative kısmındaki değişikliklerin sonunda alacağınız notu pek etkilemeyeceği. Verbal kısmının zorlaştığı kanısı da oldukça akla yatkın, zira artık önce kelime ezberleyip sonra bunları cümlede iyi kullanacak şekle girmelisiniz. Sınav yenilendi diye bölüm \ref{GREGeneral} de kararınızı değiştirmeye gerek yok, fakat Verbal'a çalışmayı  düşünüyorsanız yeni kaynaklardan çalışmanız yararınıza olur.
